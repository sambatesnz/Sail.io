        ...
        if (raceStatus == 3) {
            ...
            for (Boat boat : boats) {
                if (!finishedBoats.contains(boat)) {
                    ...
                    double newX = boat.getX() + (boat.getSpeed()*10 / (1000 / (17.0/1000)) * sin(toRadians(boat.getHeading()))) * movementMultiplier;
                    double newY = boat.getY() + (boat.getSpeed()*10 / (1000 / (17.0/1000)) * cos(toRadians(boat.getHeading()))) * movementMultiplier;
